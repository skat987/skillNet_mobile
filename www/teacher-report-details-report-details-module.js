(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["teacher-report-details-report-details-module"],{
...
/* harmony import */ var _report_details_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./report-details.page */ "./src/app/teacher/report-details/report-details.page.ts");
...
/***/ "./src/app/teacher/report-details/report-details.page.html":
/*!*****************************************************************!*\
  !*** ./src/app/teacher/report-details/report-details.page.html ***!
  \*****************************************************************/
...
/***/ "./src/app/teacher/report-details/report-details.page.scss":
/*!*****************************************************************!*\
  !*** ./src/app/teacher/report-details/report-details.page.scss ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/app/teacher/report-details/report-details.page.ts":
/*!***************************************************************!*\
  !*** ./src/app/teacher/report-details/report-details.page.ts ***!
  \***************************************************************/
...
/* harmony import */ var _models_report__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../models/report */ "./src/app/models/report.ts");
...
var ReportDetailsPage = /** @class */ (function () {
    ...
    function ReportDetailsPage(platform, route, apiService, formBuilder) {
    ...
    ReportDetailsPage.prototype.setReport = function (reportId, formationId) {
        var _this = this;
        this.apiService.get('getReport/' + reportId + '/ofFormation/' + formationId).then(function (resp) {
            // tslint:disable-next-line:max-line-length
            _this.report = new _models_report__WEBPACK_IMPORTED_MODULE_6__["Report"](resp[0].report_id, resp[0].report_title, resp[0].report_date, new _models_student__WEBPACK_IMPORTED_MODULE_5__["Student"](null, resp[0].author[0].lastname, resp[0].author[0].firstname, null, null, null, null, null, null, resp[0].student_id, resp[0].formation_id), resp[0].text, null, resp[0].report_is_daily, resp[0].created_at, resp[0].updated_at);
            for (var i = 0; i < resp[0].comments.length; i++) {
                // tslint:disable-next-line:max-line-length
                _this.report.addComment(new _models_comment__WEBPACK_IMPORTED_MODULE_4__["Comment"](resp[0].comments[i].id, resp[0].comments[i].text, new _models_student__WEBPACK_IMPORTED_MODULE_5__["Student"](resp[0].comments[i].user_id, resp[0].comments[i].lastname, resp[0].comments[i].firstname), resp[0].comments[i].created_at));
            }
        }).catch(function (e) { return console.log('Error setting report: ', e); });
    };
    Object.defineProperty(ReportDetailsPage.prototype, "f", {
        get: function () { return; },
        enumerable: true,
        configurable: true
    });
    ...
    ReportDetailsPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./report-details.page.html */ "./src/app/teacher/report-details/report-details.page.html"),
            styles: [__webpack_require__(/*! ./report-details.page.scss */ "./src/app/teacher/report-details/report-details.page.scss")],
        }),
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _service_api_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])
    ], ReportDetailsPage);
...
//# sourceMappingURL=teacher-report-details-report-details-module.js.map